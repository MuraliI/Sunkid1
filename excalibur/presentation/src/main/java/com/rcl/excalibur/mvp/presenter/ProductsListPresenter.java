...
public class ProductsListPresenter {
    ...
    public void init(int category, String childCategoryId) {
        ...
        view.init(pair -> showCollectionInView(getProductsByCategory(category, childCategoryId,
                pair.first, pair.second, activity), pair.first));
    }

    private List<Product> getProductsByCategory(int categoryId, String childCategoryId,

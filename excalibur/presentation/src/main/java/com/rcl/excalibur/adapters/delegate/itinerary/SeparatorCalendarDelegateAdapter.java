...
public class SeparatorCalendarDelegateAdapter implements DelegateAdapter<
        SeparatorCalendarDelegateAdapter.CalendarSeparatorViewHolder,
        CalendarSeparatorModel> {
    ...
    @Override
    public void onBindViewHolder(CalendarSeparatorViewHolder holder, CalendarSeparatorModel item) {

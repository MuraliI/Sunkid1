...
public class SecurityQuestionsResponseMapper extends BaseDataMapper<List<String>, SecurityQuestionsResponse, Void> {

    @Nullable
    @Override
    public List<String> transform(SecurityQuestionsResponse entity, Void additionalArg) {
